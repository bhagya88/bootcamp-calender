...
| Web Scraping / MongoDB                                                                      | 18.2     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Mongoose ORM                                                                                | 18.3     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Intro to React.js                                                                           | 19.1     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| React States and Props                                                                      | 19.2     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| MERN Stack (Mongo-Express-React-Node)                                                       | 19.3     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| React Native                                                                                | 20.1     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| React Native                                                                                | 20.2     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| React Native / Intro to Project # 3                                                         | 20.3     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Intro to PHP                                                                                | 21.1     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Intro to Laravel                                                                            | 21.2     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Laravel                                                                                     | 21.3     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Search & Sort Algorithms / Project Work                                                     | 22.1     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Intro to Data Structures / Project Work                                                     | 22.2     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Intro to Design Patterns / Project Work                                                     | 22.3     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Three Programming Languages (Ruby)                                                          | 23.1     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Three Programming Languages (Java)                                                          | 23.2     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Three Programming Languages (Python-Go-PHP-C# etc)                                          | 23.3     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Project Work                                                                                | 24.1     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Project Work                                                                                | 24.2     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Final Project Presentations                                                                 | 24.3     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Project Work                                                                                | 25.1     | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
